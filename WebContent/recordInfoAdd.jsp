...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="JavaScript">
			...
			function load(){
				...
				var star_num = ${recordInfoBean.star};
				var imgArray = $("img");
	...
	<body onload="load()">
		...
		<form:form method="post" commandName="recordInfoBean"
			action="recordinfo.ak?method=add_recordinfo_action" onsubmit="return checkEmpty()">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td style="text-align: left">
						<form:input path="initDate" readonly="true" id="cal3" cssStyle="width:54.29%"/>
					</td>
				<td>
					<label>
							状态
